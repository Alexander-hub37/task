...
<div class="max-w-lg mx-auto mt-12 px-4">
    <h1 class="text-center mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-black">Create New Task</h1>
